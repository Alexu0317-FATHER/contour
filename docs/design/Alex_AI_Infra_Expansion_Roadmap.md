...
通过 `/ai-infra:setup` skill解决。引导用户完成D和B的初始化，注入CLAUDE.md加载指令。
...
已确定方案：默认 `~/.claude/ai-infra/`，支持 `$AI_INFRA_DIR` 环境变量覆盖。跨平台路径兼容由 `~` 语法自然处理。
...
├── 💻 Coding      ████████░░ 12/20 mastered
├── 🎬 Video Edit  ███░░░░░░░ 3/15 mastered
├── 📊 Finance     █░░░░░░░░░ 1/10 mastered
└── 📚 History     ░░░░░░░░░░ new domain
```
