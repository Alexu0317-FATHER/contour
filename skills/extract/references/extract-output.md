...
Defines how `/extract` writes to extract-buffer.md (A) and reports results to the user.

---

## Write Format

Append the following formatted block to the end of A:
...
[cognition] environment variable separation
  ...
  reference: B: mastered (cognitive regression)
